...
Yet current LLM evaluations remain stuck in idealized, dyadic, noise-free environments that fail to predict behavior in messy, multi-agent realities. Early explorations \citep{akata2023playing,horton2023large,fontana2024nicer,pal2026strategiescooperationdefectionlarge} have demonstrated that LLMs can play simple repeated games, but these studies focus on rationality in controlled settings. Recent surveys \citep{sun2025game,duan2024gtbench,herr2024large} document growing interest in LLM game-theoretic evaluation, yet systematic analysis of multi-agent robustness under noise and cross-linguistic variation remains limited. The critical question remains unanswered: \textit{How do LLM agents behave when cooperation is costly, noise is inevitable, and strategic waiting is tempting?}
